        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3 sm:py-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-2xl font-bold text-blue-900">EcoSchool</h1>
                <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Панель ученика</p>
              </div>
            </div>
          ...
          <TabsContent value="overview" className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-xl sm:text-2xl font-bold text-yellow-600">{user.points}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-xl sm:text-2xl font-bold text-blue-600">
                    {classInfo?.class?.name || "Не назначен"}
                  </div>
              ...
              <Card className="sm:col-span-2 lg:col-span-1">
                ...
                <CardContent>
                  <div className="text-xl sm:text-2xl font-bold text-green-600">
                    {classInfo?.school?.name || "Не назначена"}
                  </div>
                  <p className="text-xs text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">Выберите экологическое действие для записи</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="actions">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">История ваших действий и достижений</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8">
                  <Leaf className="h-10 w-10 sm:h-12 sm:w-12 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-500 mb-4 text-sm sm:text-base">У вас пока нет записанных действий</p>
                  <Button onClick={() => router.push("/actions/log")} size="sm">
              ...
              {classInfo?.school ? (
                <>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription className="text-sm">Информация о вашей школе</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-3 sm:space-y-4">
                      {classInfo.school.address && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">{classInfo.school.address}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {classInfo.school.phone && (
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-sm sm:text-base">Телефон</p>
                            <p className="text-gray-600 text-sm">{classInfo.school.phone}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {classInfo.school.website && (
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-sm sm:text-base">Веб-сайт</p>
                            <a
                      ...
                      <div className="flex items-start gap-3">
                        <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 mt-0.5 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-sm sm:text-base">О школе</p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-sm sm:text-base">Количество классов</p>
                          <p className="text-gray-600 text-sm">{classInfo.school.total_classes}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription className="text-sm">Информация о руководстве школы</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="flex items-start gap-3 sm:gap-4">
                        <Avatar className="h-12 w-12 sm:h-16 sm:w-16 flex-shrink-0">
                          <AvatarFallback className="bg-purple-100 text-purple-700 text-sm sm:text-lg">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-gray-600 mb-2 text-sm">Директор школы</p>
                          ...
                          {classInfo.school.director_email && (
                            <div className="flex items-center gap-2 text-xs sm:text-sm">
                              ...
                              <span className="text-gray-600 break-all">{classInfo.school.director_email}</span>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm sm:text-base">Информация о школе недоступна</p>
                  </CardContent>
                </Card>
              )}
            </div>
              ...
              {classInfo?.class ? (
                <>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription className="text-sm">Информация о вашем классе</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-3 sm:space-y-4">
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                        <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-lg">
                          <div className="text-xl sm:text-2xl font-bold text-blue-600">{classInfo.class.grade}</div>
                          <div className="text-xs sm:text-sm text-gray-600">Класс</div>
                        </div>
                        <div className="text-center p-3 sm:p-4 bg-green-50 rounded-lg">
                          <div className="text-xl sm:text-2xl font-bold text-green-600">
                            {classInfo.class.student_count}
                          </div>
                          <div className="text-xs sm:text-sm text-gray-600">Учеников</div>
                        </div>
                        <div className="text-center p-3 sm:p-4 bg-purple-50 rounded-lg col-span-2 sm:col-span-1">
                          <div className="text-xl sm:text-2xl font-bold text-purple-600">
                            {classInfo.class.capacity || 30}
                          </div>
                          <div className="text-xs sm:text-sm text-gray-600">Вместимость</div>
                        </div>
                      </div>

                      <div className="space-y-2 sm:space-y-3">
                        <h4 className="font-medium text-sm sm:text-base">Статистика класса</h4>
                  ...
                  {classInfo.class.teacher_name && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription className="text-sm">Информация о вашем классном руководителе</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="flex items-start gap-3 sm:gap-4">
                          <Avatar className="h-12 w-12 sm:h-16 sm:w-16 flex-shrink-0">
                            <AvatarFallback className="bg-green-100 text-green-700 text-sm sm:text-lg">
                              {getInitials(classInfo.class.teacher_name)}
                            </AvatarFallback>
                          </Avatar>
                          <div className="flex-1 min-w-0">
                            <h3 className="text-base sm:text-lg font-semibold">{classInfo.class.teacher_name}</h3>
                            <p className="text-gray-600 mb-2 text-sm">Классный руководитель</p>
                            <p className="text-xs sm:text-sm text-gray-500 mb-3">
                            ...
                            {classInfo.class.teacher_email && (
                              <div className="flex items-center gap-2 text-xs sm:text-sm">
                                <Mail className="h-3 w-3 sm:h-4 sm:w-4 text-gray-500 flex-shrink-0" />
                                <span className="text-gray-600 break-all">{classInfo.class.teacher_email}</span>
                              </div>
                            )}
                          </div>
                        </div>
                ...
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm sm:text-base">Вы не назначены в класс</p>
                  </CardContent>
                </Card>
              )}
            </div>
